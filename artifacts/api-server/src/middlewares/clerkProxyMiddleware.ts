...
import type { IncomingHttpHeaders, ClientRequest, IncomingMessage, ServerResponse } from 'http';
  ...
  return createProxyMiddleware({
    ...
    on: {
      proxyReq: (proxyReq: ClientRequest, req: IncomingMessage) => {
        const protocol = (req.headers as IncomingHttpHeaders)['x-forwarded-proto'] || 'https';
        ...
        const xff = (req.headers as IncomingHttpHeaders)['x-forwarded-for'];
        const clientIp =
