...
const FALLBACK: KevFeed = {
  ...
  vulnerabilities: [
    ...
    { cveID:"CVE-2023-46805", vendorProject:"Ivanti",              product:"Connect Secure/Policy Secure", vulnerabilityName:"Ivanti Authentication Bypass",          dateAdded:"2024-01-19", shortDescription:"Auth bypass via path traversal",                  requiredAction:"Apply updates", dueDate:"2024-01-26", knownRansomwareCampaignUse:"Unknown", notes:"" },
...
router.get("/cisa-kev", async (_req, res) => {
  try {
    ...
    const data = (await resp.json()) as KevFeed;
