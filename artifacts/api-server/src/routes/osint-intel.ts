...
// ==========================================
router.get('/ip/:ip', async (req: Request<{ ip: string }>, res: Response): Promise<void> => {
  const { ip } = req.params;
...
// ==========================================
router.get('/domain/:domain', async (req: Request<{ domain: string }>, res: Response): Promise<void> => {
...
// HASH INTELLIGENCE
// ==========================================
router.get('/hash/:hash', async (req: Request<{ hash: string }>, res: Response): Promise<void> => {
...
router.post('/credentials', async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    if (email && validators.isEmail(email)) {
      ...
      results.sources.binaryedge = be.status === 'fulfilled' ? be.value : null;
...
router.get('/telegram/channel/:username', async (req: Request<{ username: string }>, res: Response): Promise<void> => {
...
// BLOCKCHAIN ANALYSIS
// ==========================================
router.get('/blockchain/:address', async (req: Request<{ address: string }>, res: Response): Promise<void> => {
