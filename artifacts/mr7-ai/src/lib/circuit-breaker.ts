...
class Circuit {
  ...
  private _open(): void {
    ...
    (eventBus as unknown as { emit(e: string, d: unknown): void }).emit('circuit:open', {
  ...
  private _halfOpen(): void {
    ...
    (eventBus as unknown as { emit(e: string, d: unknown): void }).emit('circuit:half-open', { endpoint: this.endpoint });
  }
  ...
  private _close(): void {
    ...
    (eventBus as unknown as { emit(e: string, d: unknown): void }).emit('circuit:closed', { endpoint: this.endpoint });
  }
