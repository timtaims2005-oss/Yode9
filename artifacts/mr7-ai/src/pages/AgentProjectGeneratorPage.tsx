          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-2">
              {PROJECT_TYPES.map(pt => (
                ...
                >
                  {(() => { const PtIco = pt.icon as React.FC<{className?: string; style?: React.CSSProperties}>; return <PtIco className="w-4 h-4 mx-auto mb-1" style={{ color: projectType === pt.id ? pt.color : "#6b7280" }} />; })()}
