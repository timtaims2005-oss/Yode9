  ...
  return (
    <div className="relative min-h-screen bg-black overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        {/* ── Demo Data Banner ── */}
        <div className="flex-shrink-0 flex items-center justify-center gap-2 py-1 px-4 text-[10px] font-mono"
          style={{ background: "rgba(234,179,8,0.12)", borderBottom: "1px solid rgba(234,179,8,0.25)", color: "#ca8a04" }}>
          <span>⚠</span>
          <span>بيانات تجريبية — هذه الواجهة تستخدم بيانات محاكاة عشوائية وليست مرتبطة بباك-إند حقيقي</span>
          <span>⚠</span>
        </div>
        <motion.header
