  ...
  const runAiAnalysis = useCallback(async() => {
    ...
    try {
      const res = await fetch("/api/chat", {
        ...
        body: JSON.stringify({ messages:[{role:"system",content:"You are an expert penetration tester and red team operator. Provide concise, technical analysis for authorized security assessments only."},{role:"user",content:aiQuery}], stream:false , useTools: true }),
      });
