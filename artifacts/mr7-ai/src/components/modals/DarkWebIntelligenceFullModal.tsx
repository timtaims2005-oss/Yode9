...
function SectionTitle({ icon: Icon, label, color = "#8b5cf6" }: { icon: React.FC<{ className?: string; style?: React.CSSProperties }>; label: string; color?: string }) {
  return (
...
export function DarkWebIntelligenceFullModal({ open, onClose }: Props) {
  ...
  const tabs: { id: MainTab; label: string; icon: React.FC<{ className?: string; style?: React.CSSProperties }>; color: string }[] = [
