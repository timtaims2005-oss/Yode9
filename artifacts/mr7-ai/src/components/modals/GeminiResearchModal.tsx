  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(0,0,0,0.85)" }}>
      <motion.div
        ...
        style={{ width: "clamp(340px, 40vw, 560px)", backdropFilter: "blur(40px)", background: "#0a0a0a", border: `1px solid ${Bg(0.25)}`, maxHeight: "90vh" }}
      >
        <div className="flex items-center justify-between px-4 pt-3 pb-[10px] border-b flex-shrink-0" style={{ borderColor: Bg(0.12) }}>
