...
function RadarPanel() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      const sweepGrad = (ctx as unknown as Record<string, unknown>).createConicalGradient ? null : null;
      ctx.save();
...
export function BootScreen({ onDone }: { onDone: () => void }) {
  ...
  const [rightTab,      setRightTab]      = useState<"log"|"nodes"|"bench"|"swarm"|"intel"|"radar"|"crypto"|"mission"|"vuln"|"net-topo"|"zero"|"siem">("log");
