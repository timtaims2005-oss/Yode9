...
interface ChatInputProps {
  ...
  enableTools: boolean;
  setEnableTools: (v: boolean | ((p: boolean) => boolean)) => void;
...
export function ChatInput({
  ...
  agentOn, setAgentOn, webOn, setWebOn, enableTools, setEnableTools,
  councilCfg, setCouncilCfg,
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-1 overflow-x-auto no-scrollbar mb-2">
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            <SquareIconBtn onClick={() => { setEnableTools((v) => !v); toast({ description: enableTools ? "Arsenal Tools off." : "🔧 Arsenal Tools enabled — AI can now control all modules." }); }} label="Enable Arsenal Tools" active={enableTools}>
